...
.cclass tr:first-child td:last-child{
	...
	<?php
	$no=1;
	$q="SELECT *,DATE_FORMAT(p.waktu,'%d-%m-%Y %h:%i:%s') AS waktu2 FROM penjualan p,kota a,provinsi b,nama_jasa_pengiriman c where p.id_kota=a.id_kota and p.id_provinsi=b.id_provinsi and p.id_nama_jasa=c.id_nama_jasa and p.id_member=$_SESSION[id1] and p.status=5";
