					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="../admin/logout.php"><i class="fa fa-crosshairs"></i> Logout</a></li>
								<?php
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a class="active" href="../kirim_bukti_transfer.php">Kirim Bukti Transfer</a></li>
								<li><a href="../status_order.php">Status Order</a></li>
