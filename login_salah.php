			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<h2>Username:<?php echo $_SESSION['username'];?>, Sudah ada...!!!.</h2>
						<form action="daftar.php" method="post">
							...
							<h2 class="naik1">Kota</h2>
							<select name="kota" id="kota" class="naik">
									<option>-select your city-</option>
							</select>
							<input type="text" name="nomorhp" placeholder="Nomor Handphone" value="<?php echo $_SESSION['nomorhp']?>;"/>
							<input type="email" name="email" placeholder="Email Address" value="<?php echo $_SESSION['email'];?>"/>
