...
<script type="text/javascript">
   ...
   <div id="container" class="row-fluid">
      <?php
		include_once("slidebar/slidebar_tambah_member.php");
	  ?>
      <!-- BEGIN PAGE -->
      <div id="main-content">
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="#">Member</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="member_add.php">Tambah Member</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
							<form action="customer_data_add.php" method="post"">
								<section class="span3">Status</section>
								<section>
									<select name="status"  id="event_priority" data-placeholder="Select Status..." class="span3 chosen">
                                          <option value=""></option>
								...
								<section>
									<input type="username" id="inputusername" name="username"/><br />
								...
								<section>
									<input id="nama" type="text" name="nama" required="required" /><br/>
								</section>
								...
								<section>
									<input id="no_telp" type="text" name="nomor_handphone" required="required" /> <br/></input>
								</section>
								<section class="span3">Alamat: </section>
								<section>
									<input id="alamat" type="text" name="alamat" required="required"/><br/></input>
								</section>
