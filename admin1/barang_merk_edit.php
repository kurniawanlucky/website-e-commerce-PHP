               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="barang_merk_edit.php">Edit Merk</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
							<form action="barang_data_merk_edit.php" method="post">
								<?php
								$result=mysql_query("select * from merk1 where id_merk=$_GET[id_merk]");
								if (!empty($result)){
									while($row=mysql_fetch_array($result))
									{
								?>
								<section class="span3 kanan">ID Merek: </section>
								<section>
									<input id="idmerk" type="text" name="idmerk" value="<?php echo $row['id_merk'];?>" readonly /><br/>
								</section>
								<section class="span3 kanan">Nama Merek: </section>
								<section>
