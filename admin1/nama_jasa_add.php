               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="nama_jasa_add.php">Tambah Nama Jasa</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
							<form action="nama_jasa_data_add.php" method="post">
								<section class="span3 kanan">Nama nama_jasa: </section>
								<section>
