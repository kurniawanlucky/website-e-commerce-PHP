...
mysql_query("INSERT INTO `detail_paket`( `id_paket_barang`, `id_barang`, `jumlah`) VALUES ('$_SESSION[id_paket_barang]',$_GET[id_barang],0)");
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
							...
							<section>
								<input id="nama" type="text" name="nama" required="required" readonly value="<?php echo $row['nama'];?>" /><br/>
							</section>
							<section class="span3 kanan">Jumlah: </section>
							<section>
								<input id="jumlah" type="text" name="jumlah" required="required" /><br/>
							</section>
