                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
							...
							<?php 
								$no=1;
								$q="select *,DATE_FORMAT(m.waktu_daftar,'%d-%m-%Y %h:%i:%s') AS waktu2 from member m,kota k,provinsi p  where m.id_kota=k.id_kota and m.id_provinsi=p.id_provinsi and m.status=1";
