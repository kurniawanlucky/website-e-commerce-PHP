               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="customer_select_penjualan.php">History Penjualan</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
							...
							<?php 
								$no=1;
								$q="SELECT *,DATE_FORMAT(p.waktu,'%d-%m-%Y %h:%i:%s') AS waktu2 FROM penjualan p,member m,kota a,provinsi b,nama_jasa_pengiriman c where p.id_member=m.id_member and  m.id_kota=a.id_kota and m.id_provinsi=b.id_provinsi and p.id_nama_jasa=c.id_nama_jasa and m.id_member=$_GET[id_member]";
							...
							?>
								...
								<?php
									...
									echo "<td> Rp ".number_format($total=$total+$row['total'],0,".",".").",-</td>";
								?>	
                                </tr>
							<?php
										$no++;
